...
function Clientes(props){
    return(
        ...
        <div className='buttons pt-1'>
            <a className='button is-primary is-clickable' onClick={(e) => props.seletorView('CadastroCliente', e)}>Cadastrar Cliente</a>
            <a className='button is-primary is-clickable' onClick={(e) => props.seletorView('CadastroDependente', e)}>Cadastrar Dependente</a>
